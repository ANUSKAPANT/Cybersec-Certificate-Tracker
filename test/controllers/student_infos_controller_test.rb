...
class StudentInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_info" do
    assert_difference('StudentInfo.count') do
      post student_infos_url, params: { student_info: { company_name: @student_info.company_name, email: @student_info.email, first_name: @student_info.first_name, last_name: @student_info.last_name, registration_type: @student_info.registration_type, title: @student_info.title } }
    end
  ...
  test "should update student_info" do
    patch student_info_url(@student_info), params: { student_info: { company_name: @student_info.company_name, email: @student_info.email, first_name: @student_info.first_name, last_name: @student_info.last_name, registration_type: @student_info.registration_type, title: @student_info.title } }
